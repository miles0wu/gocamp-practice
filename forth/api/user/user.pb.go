...
var file_api_user_user_proto_rawDesc = []byte{
	...
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x5a, 0x0a, 0x10, 0x55,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0x57, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
...
var file_api_user_user_proto_goTypes = []interface{}{
	(*GetUserInfo)(nil),      // 0: user.v1.GetUserInfo
	(*UserInfoResponse)(nil), // 1: user.v1.UserInfoResponse
}
var file_api_user_user_proto_depIdxs = []int32{
	0, // 0: user.v1.User.GetUser:input_type -> user.v1.GetUserInfo
	1, // 1: user.v1.User.GetUser:output_type -> user.v1.UserInfoResponse
